    ...
    public partial class initialClass : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Auther", x => x.AuthorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<int>(nullable: false),
                    NovelId = table.Column<int>(nullable: false),
                    AutherAuthorId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelAuthor", x => x.NovelAuthorId);
                    table.ForeignKey(
                        name: "FK_NovelAuthor_Auther_AutherAuthorId",
                        column: x => x.AutherAuthorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NovelAuthor_AutherAuthorId",
                table: "NovelAuthor",
                column: "AutherAuthorId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "NovelAuthor",
                column: "NovelId");
            var sqlFile = Path.Combine(".//DatabaseScript", @"sript.sql");
            migrationBuilder.Sql(File.ReadAllText(sqlFile));
        }

        private object PathCombine(string v, object sQLQuery)
        {
